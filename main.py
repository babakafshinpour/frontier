...
agent = DDPGagent_NN(env,hidden_size=100, actor_learning_rate=1e-4,
                  critic_learning_rate=1e-4, gamma=0.995, tau=0.05)
...
for episode in range(1000):
    ...
    sys.stdout.write("episode: {}, reward: {}, average _reward: {}, sum: {} \n".format(episode, np.round(episode_reward, decimals=2), np.mean(rewards[-10:]), sum(env.action_list[-24:])))
